...
export default function LoginPage() {
  ...
  async function connectImap(e: React.FormEvent) {
    e.preventDefault()
    if (!imapEmail || !imapPassword) { setError('Email and password are required.'); return }
    setLoading(true)
    setError('')
    try {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Welcome to MailAI</h1>
          <p className="text-sm text-gray-500 mt-1">Connect your email account to get started</p>
        </div>
        ...
        <div className="space-y-3 mb-6">
          {hasGoogle && (
            <a
              ...
              className="flex items-center justify-center gap-3 w-full py-3 px-4 border-2 border-gray-200 rounded-xl font-medium text-gray-700 hover:border-blue-400 hover:bg-blue-50 transition-colors"
            >
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white px-2 text-gray-400 font-medium">or use IMAP</span>
          </div>
        </div>
        ...
        >
          <span className="flex items-center gap-2">
            ...
            Connect via IMAP (Yahoo, AOL, custom)
          </span>
        ...
        {showImap && (
          <form onSubmit={connectImap} className="mt-4 space-y-3">
            ...
            <div>
              <label className="text-xs font-medium text-gray-600">Password / App password</label>
              <div className="relative mt-1">
              ...
              <div className="space-y-2 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="flex items-end pb-2 gap-2">
                    <label className="text-xs font-medium text-gray-600">SSL/TLS</label>
                    <input
                      type="checkbox"
                      checked={imapSecure}
